...
model.fit(train_sequences, y, validation_split=0.1, epochs=1, batch_size=128, verbose=1, shuffle=True, callbacks=[earlyStopping])
...
with open('cnn_model1_size50.csv', 'w') as csvfile:
