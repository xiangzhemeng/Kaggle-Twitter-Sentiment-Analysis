...
x_train = pd.read_pickle("clean_data/train_after_preprocess.pkl")
x_train = np.array(x_train['tweet'])

x_test = pd.read_pickle("clean_data/test_after_preprocess.pkl")
...
pickle.dump(train_model1, open('train_model/train_model1.txt', 'wb'))
test_model1 = model.predict(sequence_test)
pickle.dump(test_model1, open('test_model/test_model1.txt', 'wb'))
...
pickle.dump(train_model2, open('train_model/train_model2.txt', 'wb'))
test_model2 = model.predict(sequence_test)
pickle.dump(test_model2, open('test_model/test_model2.txt', 'wb'))
...
pickle.dump(train_model3, open('train_model/train_model3.txt', 'wb'))
test_model3 = model.predict(sequence_test)
pickle.dump(test_model3, open('test_model/test_model3.txt', 'wb'))
