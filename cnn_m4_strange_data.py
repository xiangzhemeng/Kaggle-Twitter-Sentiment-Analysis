...
#model.fit(train_sequences, y, validation_split=0.1, epochs=2, batch_size=128, verbose=1, shuffle=True)
...
with open('cnn_m4_epoch10_opsize150_strange_data.csv', 'w') as csvfile:
