...
pickle.dump(train, open('train_model1_2.txt', 'wb'))
pickle.dump(test, open('test_model1_2.txt', 'wb'))
...
train = model.predict(train_sequences, batch_size=128)
test = model.predict(test_sequences)
pickle.dump(train, open('train_model2_2.txt', 'wb'))
pickle.dump(test, open('test_model2_2.txt', 'wb'))
...
train = model.predict(train_sequences, batch_size=128)
test = model.predict(test_sequences)
pickle.dump(train, open('train_model3_2.txt', 'wb'))
pickle.dump(test, open('test_model3_2.txt', 'wb'))
...
train = model.predict(train_sequences, batch_size=128)
test = model.predict(test_sequences)
pickle.dump(train, open('train_model4_2.txt', 'wb'))
pickle.dump(test, open('test_model4_2.txt', 'wb'))
